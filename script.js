...
if (passOrFail = (average >= passingGrade)) {
    console.log(`${studentFirstName} ${studentLastName} passed with a grade of ${average}.`);
} else {
    console.log(`${studentFirstName} ${studentLastName} did not pass with a grade of ${average}.`);
}